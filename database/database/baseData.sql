...
INSERT INTO role (id, description, create_user, create_date, update_user, update_date)
VALUES (2, 'Manager', 'SYSTEM', now(), 'SYSTEM', now());
INSERT INTO role (id, description, create_user, create_date, update_user, update_date)
VALUES (3, 'Employee', 'SYSTEM', now(), 'SYSTEM', now());
INSERT INTO role (id, description, create_user, create_date, update_user, update_date)
VALUES (4, 'User', 'SYSTEM', now(), 'SYSTEM', now());

DELETE FROM dept;
INSERT INTO dept (id, description, create_user, create_date, update_user, update_date)
VALUES (1, 'Default', 'SYSTEM', now(), 'SYSTEM', now());
